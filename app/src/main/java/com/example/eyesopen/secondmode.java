...
public class secondmode extends AppCompatActivity {
    ...
    Button firstmodebutton3;
    Button secondmodebutton3;
    ImageView imageView5;
    ImageView imageView7;
    TextToSpeech tts;
    ConstraintLayout secondmodelayout;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.secondmode);
        secondmodelayout = (ConstraintLayout) findViewById(R.id.secondmodelayout);
        firstmodebutton3 = (Button) findViewById(R.id.firstmodebutton3);
        secondmodebutton3 = (Button) findViewById(R.id.secondmodebutton3);
        ...
        secondmodelayout.setOnClickListener(new View.OnClickListener() {
            @Override
                    ...
                    public void handleMessage(@NonNull Message msg) {
                        ...
                        for(int i=0;i<t.matches.size();i++){
                            if(t.matches.get(i).equals("거리")){
                                Intent j = new Intent(secondmode.this,firstmode.class);
                                startActivity(j);
                            }
                            else if (t.matches.get(i).equals("읽기")){
                                Intent k = new Intent(secondmode.this, secondmode.class);
                                startActivity(k);
                            }
                            ...
                            Toast.makeText(secondmode.this, t.matches.get(i), Toast.LENGTH_SHORT).show();
                        }
                    }

                };

                t.callstt(secondmode.this, handler);
            }
        });

        firstmodebutton3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(secondmode.this, firstmode.class);
                startActivity(i);
            }
        });

        secondmodebutton3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(secondmode.this, secondmode.class);
                startActivity(i);
            }
        });
